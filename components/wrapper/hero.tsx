...
export default function Hero({
	...
	return (
		<div className='relative min-h-screen'>
			<div className='min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-100 to-purple-100 w-full'>
				<FloatingBubbles />
			...
			<div className='h-[10vh] bg-purple-100 w-full flex items-center justify-center'>
				<p className='text-center text-sm'>
					Created with ❤️ by Shriansh Agarwal
				</p>
			</div>
		</div>
	);
